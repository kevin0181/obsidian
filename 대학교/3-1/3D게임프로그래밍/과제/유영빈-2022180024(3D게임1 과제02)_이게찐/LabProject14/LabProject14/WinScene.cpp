...
ID3D12RootSignature* WinScene::CreateGraphicsRootSignature(ID3D12Device* pd3dDevice)
{
...
bool WinScene::OnProcessingMouseMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM
	lParam)
{
	return(false);
}

bool WinScene::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam,
	LPARAM lParam)
{
	return(false);
}

bool WinScene::ProcessInput()
{
	return(false);
}
...
ID3D12RootSignature* WinScene::GetGraphicsRootSignature()
{
	return(m_pd3dGraphicsRootSignature);
}

void WinScene::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
