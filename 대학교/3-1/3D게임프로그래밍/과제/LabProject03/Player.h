...
public:
	...
	const std::vector<CBulletObject*>& GetBullets() const { return m_ppBullets; }
protected:
	bool m_bIsRecoiling{};
...
class TankPlayer : public CPlayer
{
public:
...
private:
	...
	virtual void Animate(float fTimeElapsed, XMFLOAT4X4 *  = NULL) override;
