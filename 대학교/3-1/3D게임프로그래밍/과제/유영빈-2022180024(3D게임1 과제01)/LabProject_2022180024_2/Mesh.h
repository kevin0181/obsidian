...
public:
	CLineMesh(XMFLOAT3& p0, XMFLOAT3& p1);
	virtual ~CLineMesh() {}
};
...
{
public:
	CTankMesh(float width, float height, float depth);
	virtual ~CTankMesh() {}
};


class CLevel2WallMesh : public CMesh
{
public:
	CLevel2WallMesh(float fWidth = 4.0f, float fHeight = 4.0f, float fDepth = 4.0f, int nSubRects = 20);
	virtual ~CLevel2WallMesh() {}
};