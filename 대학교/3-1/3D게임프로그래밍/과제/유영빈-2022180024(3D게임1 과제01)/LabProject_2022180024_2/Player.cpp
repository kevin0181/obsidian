...
void Level1Player::Animate(float fElapsedTime)
{
	CPlayer::Animate(fElapsedTime);
}

void Level1Player::OnUpdateTransform()
{
	CPlayer::OnUpdateTransform();
...
void Level1Player::Render(HDC hDCFrameBuffer, CCamera* pCamera)
{
	CPlayer::Render(hDCFrameBuffer, pCamera);
}