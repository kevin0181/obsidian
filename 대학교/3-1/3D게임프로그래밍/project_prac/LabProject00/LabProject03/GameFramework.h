...
private:
	...
	// 스왑 체인 인터페이스에 대한 포인터, 주로 디스플레이를 제어하기 위해 필요하다.
	ID3D12Device* m_pd3dDevice;
	// Direct3D 디바이스 인터페이스에 대한 포인터, 주로 리소스를 생성하기 위해 필요하다.
...
public:
	...
	//프레임 워크의 핵심 (사용자 입력, 애니메이션, 렌더링)을 구성하는 함수
	void ProcessInput();
	void AnimateObjects();
	void FrameAdvance();
